...
```powershell
dotnet test OverkizCrestronDriver.WorkflowTests/OverkizCrestronDriver.WorkflowTests.csproj -c Release --list-tests
dotnet test OverkizCrestronDriver.WorkflowTests/OverkizCrestronDriver.WorkflowTests.csproj -c Release --filter FullyQualifiedName=CrestronHome.Workflows.overkizcrestrondriver_driver
```
